...
class Jquery_Pagination
{
	...
	var $uri_segment		= 3;
	var $full_tag_open		= '<div class="dataTables_paginate paging_bootstrap"><ul class="pagination col-sm-12">';
   ...
   var $show_count      = true;
	...
	function create_links()
	{
      ...
      if ($this->show_count)
      {
         ...
         $info .= ' of ' . $this->total_rows . ' entries  </div></div> ';
	...
	function getAJAXlink( $count, $text) {
		...
		return "<a href=\"javascript:void(0);\"
		         " . $this->anchor_class . "
					onclick=\"jQuery.post('". $this->base_url . $count ."', ". $this->additional_param .", function(data){
					jQuery('". $this->div . "').hide(); jQuery('". $this->div . "').html(data); jQuery('". $this->div . "').fadeIn(300);" . $this->js_rebind ."; }); return false;\">"
				. $text .'</a>';
	}
